...
class ProfileConfigLoader:
    ...
    def _load_pyproject_toml(self) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            drill_sergeant_config = data.get("tool", {}).get("pytest-drill-sergeant", {})
    ...
    def _load_pytest_ini(self) -> Optional[Dict[str, Any]]:
    ...
    def _convert_pyproject_config(self, config: Dict[str, Any]) -> Dict[str, Any]:
        ...
        direct_mappings = [
            "profile", "ci_profile", "fail_on", "report", "verbose", "quiet",
            "json_report_path", "sarif_report_path"
        ]
    ...
    def _convert_config_value(self, key: str, value: str) -> Any:
        ...
        if key in [
            "profile", "ci_profile", "fail_on", "report",
            "json_report_path", "sarif_report_path"
        ]:
            return value
    ...
    def _create_ds_config(self, config_data: Dict[str, Any]) -> DSConfig:
        ...
        if "project_root" in config_data and isinstance(config_data["project_root"], str):
        ...
        try:
            ...
            filtered_config_data = {k: v for k, v in config_data.items() if k in dsconfig_fields}
