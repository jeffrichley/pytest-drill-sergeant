...
_current_config: ContextVar[Optional[DSConfig]] = ContextVar(
    "ds_config", default=None
)

# Context variable for storing the project root
_project_root: ContextVar[Optional[Path]] = ContextVar(
    "ds_project_root", default=None
)
...
class ConfigContext:
    ...
    def __init__(self, config: Optional[DSConfig] = None):
    ...
    def reload(
        ...
        return cls.initialize(cli_args, pytest_config, cls.get_project_root(), force_reload=True)
