...
''')
    ...
    def test_extract_coverage_data_with_analysis(self):
        ...
        with patch.object(collector, '_extract_coverage_data', return_value=base_coverage):
            # Test enhanced extraction
            enhanced_coverage = collector._extract_coverage_data_with_analysis(
                Path("/test/test.py"), "test_example", 10, [Path("file1.py"), Path("file2.py")]
            )
