...
'''
        ...
        with tempfile.NamedTemporaryFile(mode='w', suffix='.py', delete=False) as f:
            ...
            import_findings = [f for f in findings if f.metadata["violation_type"] == "private_import"]
            attr_findings = [f for f in findings if f.metadata["violation_type"] == "private_attribute"]
            method_findings = [f for f in findings if f.metadata["violation_type"] == "private_method"]
