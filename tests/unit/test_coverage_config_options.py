...
class TestCoverageConfigLoading:
    ...
    def test_load_json_config(self):
        ...
        config_data = {"threshold": 80.0, "output": "report.json", "format": "json"}
    ...
    def test_load_yaml_config(self):
        ...
        config_data = {"threshold": 75.0, "output": "report.yaml", "format": "html"}
...
class TestCoverageReportGeneration:
    ...
    def test_generate_text_report(self):
        ...
        config = {"threshold": 60.0, "format": "text"}
    ...
    def test_generate_json_report(self):
        ...
        config = {"threshold": 70.0, "format": "json"}
        ...
        assert (
            report_data["coverage_analysis"]["summary"] == "Coverage analysis completed"
        )

    def test_generate_html_report(self):
        """Test generating HTML format report."""
        config = {"threshold": 80.0, "format": "html"}
...
class TestCoverageAnalysisProcessing:
    ...
    def test_process_coverage_analysis_success(self, mock_echo):
        ...
        config = {"threshold": 65.0, "output": "test_report.json", "format": "json"}
