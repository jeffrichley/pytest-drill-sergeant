...
class TestConfigRegistryInitialization:
    ...
    def test_initialize_with_profile_loader_success(self):
        ...
        with patch("pytest_drill_sergeant.core.config_registry.ProfileConfigLoader") as mock_loader_class:
            mock_loader = Mock()
    ...
    def test_initialize_with_profile_loader_failure(self):
        ...
        with patch("pytest_drill_sergeant.core.config_registry.ProfileConfigLoader") as mock_loader_class:
            ...
            with patch("pytest_drill_sergeant.core.config_registry.create_default_config") as mock_default:
    ...
    def test_initialize_logs_warning_on_failure(self):
        ...
        with patch("pytest_drill_sergeant.core.config_registry.ProfileConfigLoader") as mock_loader_class:
            ...
            with patch("pytest_drill_sergeant.core.config_registry.create_default_config"):
                with patch("logging.getLogger") as mock_logger:
                    ...
                    assert "Failed to load configuration, using defaults" in mock_log.warning.call_args[0][0]
...
class TestGlobalRegistryFunctions:
    ...
    def test_initialize_config_delegates_to_registry(self):
        ...
        with patch("pytest_drill_sergeant.core.config_registry._registry") as mock_registry:
            ...
            mock_registry.initialize.assert_called_once_with(cli_args, pytest_config, project_root)
        ...
        with patch("pytest_drill_sergeant.core.config_registry.ProfileConfigLoader") as mock_loader_class:
            ...
            with patch("pytest_drill_sergeant.core.config_registry.create_default_config"):
                with patch("logging.getLogger") as mock_logger:
                    ...
                    assert "Failed to load configuration, using defaults" in call_args[0]
