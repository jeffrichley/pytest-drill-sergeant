...
class TestAnalysisPipeline:
    ...
    def test_analyze_file_single_analyzer(
        self, pipeline: AnalysisPipeline, sample_finding: Finding, tmp_path: Path
    ) -> None:
    ...
    def test_analyze_file_multiple_analyzers(
        self, pipeline: AnalysisPipeline, tmp_path: Path
    ) -> None:
    ...
    def test_analyze_files_multiple(
        ...
        findings_by_file, errors_by_file = pipeline.analyze_files(
