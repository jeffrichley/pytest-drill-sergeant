        ...
        with patch("pytest_drill_sergeant.lsp.server.create_analysis_pipeline"):
            with patch("pytest_drill_sergeant.lsp.server.get_config"):
                with patch("pytest_drill_sergeant.lsp.server.setup_standard_logging"):
                    ...
                    assert server._convert_severity("warning") == DiagnosticSeverity.Warning
                    assert server._convert_severity("info") == DiagnosticSeverity.Information
                    assert server._convert_severity("hint") == DiagnosticSeverity.Hint
                    assert server._convert_severity("unknown") == DiagnosticSeverity.Warning
