...
class TestCoverageStorageConfig:
    ...
    def test_custom_config(self):
        ...
        config = CoverageStorageConfig(
            storage_path=custom_path, retention_days=7, compression=False, enabled=False
        )
...
class TestCoverageStorage:
    ...
    def test_storage_disabled(self, temp_storage_path):
        ...
        config = CoverageStorageConfig(storage_path=temp_storage_path, enabled=False)
    ...
    def test_store_test_data(
        self, storage, mock_coverage_data, mock_car_result, mock_coverage_signature
    ):
    ...
    def test_store_file_data(self, storage):
        ...
        # Check file contents
        with open(file_storage_path) as f:
            data = json.load(f)
    ...
    def test_get_all_signatures(self, storage, mock_coverage_signature):
        ...
        storage.store_coverage_signature(
            test_name1, mock_coverage_signature, session_id
        )
    ...
    def test_find_similar_signatures(self, storage, mock_coverage_signature):
        ...
        similar_signatures = storage.find_similar_signatures(
            similar_signature, similarity_threshold=0.8
        )
