...
class TestMockOverspecDetector:
    ...
    def test_is_mock_target_allowed_basic_patterns(
        self, detector: MockOverspecDetector
    ) -> None:
    ...
    def test_is_mock_target_allowed_complex_patterns(
        self, detector: MockOverspecDetector
    ) -> None:
    ...
    def test_extract_mock_target_simple_name(
        self, detector: MockOverspecDetector
    ) -> None:
    ...
    def test_extract_mock_target_chained_calls(
        self, detector: MockOverspecDetector
    ) -> None:
    ...
    def test_extract_mock_target_complex_expression(
        self, detector: MockOverspecDetector
    ) -> None:
    ...
    def test_count_mock_assertions_under_threshold(
        self, detector: MockOverspecDetector, tmp_path: Path
    ) -> None:
...
"""
    ...
    def test_count_mock_assertions_over_threshold(
        self, detector: MockOverspecDetector, tmp_path: Path
    ) -> None:
...
"""
    ...
    def test_mixed_allowed_and_disallowed_mocks(
        self, detector: MockOverspecDetector, tmp_path: Path
    ) -> None:
...
"""
    ...
    def test_different_mock_assertion_types(
        self, detector: MockOverspecDetector, tmp_path: Path
    ) -> None:
