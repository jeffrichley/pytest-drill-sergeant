...
class TestFilePatternMatching:
    ...
    def test_venv_pattern_matching(self):
        ...
        assert pattern.matches(Path("/project/.venv/lib/python3.9/site-packages/package.py"), project_root)
...
class TestFileDiscoveryIntegration:
    ...
    def test_file_discovery_filters_files_correctly(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            config = self.create_test_config(project_root, test_patterns=["**/test_*.py"])
            discovery_config = FileDiscoveryConfig(config)
    ...
    def test_file_discovery_no_gitignore_file(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            config = self.create_test_config(project_root, ignore_patterns=["existing_pattern"])
            discovery_config = FileDiscoveryConfig(config)
    ...
    def test_file_discovery_gitignore_parsing_error(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with patch('pytest_drill_sergeant.core.file_discovery.parse_gitignore', 
...
""")
            ...
            assert (project_root / "tests/integration/test_integration.py") in discovered_files
            ...
            assert (project_root / "node_modules/package/index.js") not in discovered_files
